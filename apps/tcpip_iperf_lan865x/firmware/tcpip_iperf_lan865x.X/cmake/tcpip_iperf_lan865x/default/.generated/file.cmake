...
set(tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_assemble)
set_source_files_properties(${tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_assembleWithPreprocess)
set_source_files_properties(${tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_assembleWithPreprocess} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_assembleWithPreprocess})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()
...
set_source_files_properties(${tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_compile_cpp)
set_source_files_properties(${tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_compile_cpp} PROPERTIES LANGUAGE CXX)
set(tcpip_iperf_lan865x_default_default_XC32_FILE_TYPE_link)

# The linker script used for the build.
set(tcpip_iperf_lan865x_default_LINKER_SCRIPT "${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/config/default/ATSAME54P20A.ld")
set(tcpip_iperf_lan865x_default_image_name "default.elf")
set(tcpip_iperf_lan865x_default_image_base_name "default")

# The output directory of the final image.
set(tcpip_iperf_lan865x_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/tcpip_iperf_lan865x")

# The full path to the final image.
set(tcpip_iperf_lan865x_default_full_path_to_image ${tcpip_iperf_lan865x_default_output_dir}/${tcpip_iperf_lan865x_default_image_name})
